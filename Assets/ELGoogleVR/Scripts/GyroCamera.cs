    ...
    public class GyroCamera : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            if (SystemInfo.supportsGyroscope)
            {
				...
				this.gameObject.GetComponent<TouchCamera> ().enabled = false;
            }
            else
            {
                enabled = false;
            ...
            _rawGyroRotation = gameObject.transform;
        ...
        private void ApplyGyroRotation()
        {
            ...
            _rawGyroRotation.Rotate(90f, 45f, 0f, Space.World); // Rotate to make sense as a camera pointing out the back of your device.
